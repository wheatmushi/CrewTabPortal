...
def bar_graph(stats, periods=7):
    x = stats.index[-periods:]
    y_count = stats['flightsCount'][-periods:]
    y_week_excess = stats['vsWeek +'][-periods:]
    y_week_missing = stats['vsWeek -'][-periods:]
    y_month = stats['vsMonth'][-periods:]
    ...
    fig, (ax_count, ax_week, ax_month) = plt.subplots(3, 1, figsize=(periods, 10))
