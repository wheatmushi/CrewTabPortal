...
name_to_position = {'AAQ (ret)': 10, 'AER (ret)': 11, 'AGP (ret)': 12, 'VLC (ret)': 12, 'ALC (ret)': 12, 'ARN (ret)': 13, 'ASF (ret)': 13, 'BKK (ret)': 14, 'HKT (ret)': 14, 'CAN (ret)': 15, 'CEK (ret)': 16, 'CMB (ret)': 16, 'CMN (ret)': 16, 'CUN (ret)': 16, 'DEL (ret)': 17, 'DUS (ret)': 18, 'DXB (ret)': 19, 'DWC (ret)': 19, 'EVN (ret)': 20, 'HAN (ret)': 21, 'HAV (ret)': 22, 'VRA (ret)': 22, 'HKG (ret)': 23, 'IAD (ret)': 24, 'ICN (ret)': 25, 'IKT (ret)': 26, 'JFK (ret)': 27, 'KHV (ret)': 28, 'KRR (ret)': 29, 'LAX (ret)': 30, 'LIS (ret)': 31, 'MAD (ret)': 32, 'MIA (ret)': 33, 'MLE (ret)': 34, 'MRV (ret)': 34, 'NRT (ret)': 35, 'PEE (ret)': 36, 'PEK (ret)': 37, 'PKC (ret)': 38, 'PMI (ret)': 38, 'PRG (ret)': 39, 'PUJ (ret)': 39, 'PVG (ret)': 40, 'SEZ (ret)': 40, 'SGN (ret)': 41, 'SIP (ret)': 42, 'STW (ret)': 43, 'SVX (ret)': 44, 'TFS (ret)': 45, 'TLV (ret)': 46, 'UFA (ret)': 47, 'ULN (ret)': 48, 'UUS (ret)': 49, 'VVO (ret)': 50, 'YKS (ret)': 51, 'TST (ret)': 999, 'AGP  VLC  ALC (ret)': 12, 'BKK  HKT (ret)': 14, 'DXB  DWC (ret)': 19, 'HAV  VRA (ret)': 22, '2-6hr. Breakfast': 2, '2-6hr. Lunch': 3, '6+ hours': 4}
